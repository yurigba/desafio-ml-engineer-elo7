"""Desafio Machine Learning Engineer file for ensuring the package is executable
as `desafio-machine-learning-engineer` and `python -m desafio_machine_learning_engineer`
"""
import importlib
